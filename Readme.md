...
* Студент: [Студентище Неопознанный](http://up.htmlacademy.local/htmlcss/20/user/42701).
...
[Откройте мастер-репозиторий](https://github.com/optimus-htmlcss/42701-barbershop) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
